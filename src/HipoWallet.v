    ...
    ::// if (! isEmpty (custom_payload) ) then { ->/> } . 
      {
        ...
        ::// var0 ss: TvmSlice := {} (* custom_payload -> toSlice() *) ; _ | .  (* TODO : many difficult types...*)
        (* mode = ss~load_uint(4); *)
